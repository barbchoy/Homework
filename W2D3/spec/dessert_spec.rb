...
describe Dessert do
  let(:chef) { double("chef", name: "Barbara") }
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["chocolate", "sugar", "flour", "butter"]
    end
  ...
  describe "#serve" do
    ...
    allow(chef).to receive(:titleize).and_return("Chef Barbara the Great Baker")
    expect(cookie.serve).to eq("Chef Barbara the Great Baker has made 100 brownies!")
    end
  end
